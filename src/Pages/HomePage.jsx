          ...
          >
            ...
            <div className="w-screen text-5xl my-24">
              ...
              <div className="h-32  flex items-center justify-center">
                <img className="w-24 h-20" src="/arrow.png" alt="" />
              </div>
              ...
              >
                ...
                <div className="text-2xl text-gray-400">The Bidding Round</div>
              ...
              >
                1. Failure to satisfy the rules will lead to disqualification of
                the team. <br />
